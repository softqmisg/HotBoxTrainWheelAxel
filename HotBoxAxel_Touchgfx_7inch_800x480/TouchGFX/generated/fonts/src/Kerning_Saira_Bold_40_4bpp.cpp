...
KEEP extern const touchgfx::KerningNode kerning_Saira_Bold_40_4bpp[] FONT_KERNING_LOCATION_FLASH_ATTRIBUTE = {
    ...
    { 0x00BF,  4 },  // (First char = [0x00BF, questiondown], Second char = [0x006A, j], Kerning dist = 4)
    ...
    { 0x004C, -4 },  // (First char = [0x004C, L], Second char = [0x201D, quotedblright], Kerning dist = -4)
